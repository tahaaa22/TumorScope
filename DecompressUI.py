...
"border:none;\n"
"}\n"
"#load_button, #decompression_button {\n"
...
"}\n"
"#analysis_button, #compress_button,#load_button, #decompression_button, #decompress_button, #confirmButton{\n"
"padding:10px 5px;\n"
"text-align:left;\n"
"font: 18px;\n"
"}\n"
...
"}\n"
"\n"
"#SearchFrame, #load_button, #decompression_button, #menu_button{\n"
"border-radius: 10px;\n"
...
"}")
        ...
        self.normal_image.setMinimumSize(QtCore.QSize(400, 0))
        ...
        self.dicom_size = QtWidgets.QLabel(self.frame_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.dicom_size.setFont(font)
        self.dicom_size.setObjectName("dicom_size")
        self.horizontalLayout_4.addWidget(self.dicom_size)
        ...
        self.dicom_image.setMinimumSize(QtCore.QSize(400, 0))
        ...
        self.normal_size_2 = QtWidgets.QLabel(self.frame_11)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.normal_size_2.setFont(font)
        self.normal_size_2.setObjectName("normal_size_2")
        self.horizontalLayout_6.addWidget(self.normal_size_2)
        ...
        self.normal_extension_2 = QtWidgets.QLabel(self.frame_11)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.normal_extension_2.setFont(font)
        self.normal_extension_2.setObjectName("normal_extension_2")
        self.horizontalLayout_7.addWidget(self.normal_extension_2)
        ...
        self.decompression_button = QtWidgets.QPushButton(self.widget)
        self.decompression_button.setMinimumSize(QtCore.QSize(0, 0))
        self.decompression_button.setObjectName("decompression_button")
        self.horizontalLayout_3.addWidget(self.decompression_button, 0, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.EMGlabel.setText(_translate("MainWindow", "DICOM Image"))
        ...
        self.normal_extension.setText(_translate("MainWindow", "DCM"))
        self.filterflex.setText(_translate("MainWindow", "Normal Image"))
        self.label_3.setText(_translate("MainWindow", "Original Size:"))
        self.normal_size_2.setText(_translate("MainWindow", "500KB"))
        self.label_5.setText(_translate("MainWindow", "Extension:"))
        self.normal_extension_2.setText(_translate("MainWindow", "PNG"))
        self.load_button.setText(_translate("MainWindow", "Load Image"))
        self.decompression_button.setText(_translate("MainWindow", "decompress"))
