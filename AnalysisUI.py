...
"}\n"
"#analysis_button, #compress_button,  #decompress_button, #confirmButton{\n"
"padding:10px 5px;\n"
"text-align:left;\n"
"font: 18px;\n"
"}\n"
...
"}")
        ...
        self.headerframe = QtWidgets.QWidget(self.centralwidget)
        self.headerframe.setObjectName("headerframe")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.headerframe)
        self.horizontalLayout_2.setContentsMargins(8, 0, 8, 10)  # Adjusted margins
        ...
        #self.menu_button.clicked.connect(self.toggle_full_screen)
        self.horizontalLayout_2.addWidget(self.menu_button, 0, QtCore.Qt.AlignLeft)

        # Add spacer to center the label
        self.left_spacer = QtWidgets.QSpacerItem(600, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.cardsframe)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.widget_4 = QtWidgets.QWidget(self.cardsframe)
        self.widget_4.setMinimumSize(QtCore.QSize(400, 400))
        self.widget_4.setMaximumSize(QtCore.QSize(400, 400))
        self.widget_4.setObjectName("widget_4")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.widget_4)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.EMGlabel = QtWidgets.QLabel(self.widget_4)
        self.EMGlabel.setAlignment(QtCore.Qt.AlignCenter)
        self.EMGlabel.setMinimumSize(QtCore.QSize(400, 50))
        self.EMGlabel.setMaximumSize(QtCore.QSize(400, 50))
        font = QtGui.QFont()
        ...
        self.verticalLayout_4.addWidget(self.EMGlabel)
        self.frame_3 = QtWidgets.QFrame(self.widget_4)
        self.frame_3.setMinimumSize(QtCore.QSize(400, 350))
        self.frame_3.setMaximumSize(QtCore.QSize(400, 350))
        ...
        self.loaded_image.setMaximumSize(QtCore.QSize(400, 350))
        self.loaded_image.setObjectName("loaded_image")
        self.verticalLayout_6.addWidget(self.loaded_image, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        self.verticalLayout_4.addWidget(self.frame_3)
        self.horizontalLayout_4.addWidget(self.widget_4)
        self.widget_5 = QtWidgets.QWidget(self.cardsframe)
        self.widget_5.setMinimumSize(QtCore.QSize(400, 400))
        ...
        self.filterflex = QtWidgets.QLabel(self.widget_5)
        self.filterflex.setAlignment(QtCore.Qt.AlignCenter)
        self.filterflex.setMinimumSize(QtCore.QSize(400, 50))
        self.filterflex.setMaximumSize(QtCore.QSize(400, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayout_5.addWidget(self.filterflex)
        self.frame_8 = QtWidgets.QFrame(self.widget_5)
        self.frame_8.setMinimumSize(QtCore.QSize(400, 350))
        self.frame_8.setMaximumSize(QtCore.QSize(400, 350))
        ...
        self.segmented_image = ImageView(self.frame_8)
        ...
        self.segmented_image.setMaximumSize(QtCore.QSize(400, 350))
        self.segmented_image.setObjectName("segmented_image")
        self.verticalLayout_11.addWidget(self.segmented_image)
        self.verticalLayout_5.addWidget(self.frame_8)
        self.horizontalLayout_4.addWidget(self.widget_5)
        self.widget_6 = QtWidgets.QWidget(self.cardsframe)
        self.widget_6.setMinimumSize(QtCore.QSize(400, 400))
        self.widget_6.setMaximumSize(QtCore.QSize(400, 400))
        self.widget_6.setObjectName("widget_6")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget_6)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.detect_label = QtWidgets.QLabel(self.widget_6)
        self.detect_label.setAlignment(QtCore.Qt.AlignCenter)  
        self.detect_label.setMinimumSize(QtCore.QSize(400, 50))
        self.detect_label.setMaximumSize(QtCore.QSize(400, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayout_3.addWidget(self.detect_label)
        ...
        self.detected_image = ImageView(self.frame_11)
        self.detected_image.ui.roiBtn.hide()  
        self.detected_image.ui.menuBtn.hide() 
        self.detected_image.ui.histogram.hide() 
        self.detected_image.setMinimumSize(QtCore.QSize(400, 350))
        self.detected_image.setMaximumSize(QtCore.QSize(400, 350))
        self.detected_image.setObjectName("detected_image")
        self.verticalLayout_14.addWidget(self.detected_image, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.appheader.setAlignment(QtCore.Qt.AlignVCenter)
