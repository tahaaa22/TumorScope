...
"}")
        ...
        self.verticalLayout_17.addWidget(self.segmented_image,0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        self.verticalLayout_2.addWidget(self.detected_image,0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
